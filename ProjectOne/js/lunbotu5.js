...
class lunbotu5 {
    ...
    createHTML() {
        ...
        let html = this.data.map((ele) => {
            return `<li class="slider-box-item"><a href=${ele.a_href}><img src=${ele.img_src} alt=""></a></li>`
...
var oLunbotu5 = document.querySelector("#lunbotu5");

var banner5 = new lunbotu5(lunbotu5_data, oLunbotu5);
banner5.init();